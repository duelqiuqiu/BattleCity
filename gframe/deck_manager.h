...
public:
	...
	void LoadDeck(Deck& deck, std::function<bool(int)> filter, std::vector<char> dbuf);
	void LoadDeck(Deck& deck, std::function<bool(int)> filter, int* codeBuff, int mainc, int sidec);
