...
public:
	...
	irr::gui::CGUITTFont* guiFont = nullptr;
	irr::gui::CGUITTFont* textFont = nullptr;
	irr::gui::CGUITTFont* numFont = nullptr;
	irr::gui::CGUITTFont* adFont = nullptr;
	irr::gui::CGUITTFont* lpcFont = nullptr;
	...
	irr::gui::IGUIButton* btnPlayWithAI;
	...
	irr::gui::IGUIButton* btnRightClick;
	// ÒôÁ¿¿ª¹Ø
	irr::gui::IGUICheckBox* chkEnableSound;

	float xScale = 1.0f;
	float yScale = 1.0f;
	std::shared_ptr<SoundEffectPlayer> soundEffectPlayer;
	bool isPSEnabled;
#ifdef _IRR_ANDROID_PLATFORM_
	android_app* appMain;
	int glversion;
...
#endif
#define BUTTON_RIGHTCLICK		100000000
#endif // GAME_H
