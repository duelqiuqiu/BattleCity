...
public:
	...
	const wchar_t* GetCustomString(int code);
	...
	std::unordered_map<unsigned int, std::wstring> _customStrings;
	...
	static byte* ScriptReader(const char* filename, int* readlen);
